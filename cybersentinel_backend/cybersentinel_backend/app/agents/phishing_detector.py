...
class PhishingDetectorAgent:
    ...
    async def analyze(self, url: str) -> dict:
        ...
        prompt = PHISHING_ANALYSIS_PROMPT.format(
            ...
            has_login_form=features.get("has_login_form", features.get("has_password_field", False)),
        ...
        return {
            ...
            "brand_impersonated": ai.get("brand_impersonated") or features.get("brand_impersonated"),
            "features":           features,
